...
public class FriendBackController {
		private static FriendBackController instance;
	    private Activity activity1, activity2, activity3, activity4, activity5;

	    private FriendBackController() {}
	    
	    public static synchronized FriendBackController getInstance() {
	        if(instance == null) {
	            instance = new FriendBackController();
	        }
